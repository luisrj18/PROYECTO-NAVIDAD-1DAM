...
public class BullyingStopComentarios extends javax.swing.JFrame {
    
   conexionMysql con = new conexionMysql();
   Connection cn = con.conectar();
  
    
    public BullyingStopComentarios() {     
    ...
    private void initComponents() {
        ...
        txtfecha_comentarios = new javax.swing.JTextField();
        ...
        txtcomentarios.setBorder(javax.swing.BorderFactory.createTitledBorder("Comentario"));

        txtfecha_comentarios.setBorder(javax.swing.BorderFactory.createTitledBorder("Fecha Comentario"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtcomentarios, javax.swing.GroupLayout.DEFAULT_SIZE, 187, Short.MAX_VALUE)
                    .addComponent(txtfecha_comentarios)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(txtfecha_comentarios, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39)
        ...
        jMenu1.setLabel("Comentarios");

        jMenuItem1.setText("Nuevo Comentario");
    ...
    private void btnregistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregistrarActionPerformed
        // TODO add your handling code here:
         try {
         PreparedStatement ps = cn.prepareStatement ("INSERT INTO comentarios (alias,comentario,fecha_comentario) VALUES (?,?,?)");
         ps.setString(1, txtalias.getText());
         ps.setString(2, txtcomentarios.getText());
         ps.setString(3, txtfecha_comentarios.getText());
         ps.execute();
    ...
    private void btnactualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnactualizarActionPerformed
        ...
        ("UPDATE comentarios SET alias = ?,comentario = ?,fecha_comentario =? WHERE comentarios.id='"+txtid.getText()+"';");
         ps.setString(1, txtalias.getText());
         ps.setString(2, txtcomentarios.getText());
         ps.setString(3, txtfecha_comentarios.getText());
         ps.execute();
         ...
         limpiardatos();  
             ...
             JOptionPane.showMessageDialog(null, "ERROR AL ACTUALIZAR COMENTARIO" +e);
        }
    ...
    private void jtabledatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtabledatosMouseClicked
            ...
            if (selectedRow != -1) {
                ...
                txtcomentarios.setText(publicacion.toString());
                txtfecha_comentarios.setText(fecha_publicacion.toString());
...
try {
         PreparedStatement ps = cn.prepareStatement 
        ("DELETE FROM comentarios WHERE comentarios.id ='"+txtid.getText()+"';");
         ps.execute();
         ...
         limpiardatos();  
            ...
            JOptionPane.showMessageDialog(null, "HA HABIDO UN ERROR COMENTARIO" +e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BullyingStopComentarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BullyingStopComentarios().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtfecha_comentarios;
    ...
    private void mostrardatos() {
        ...
        modelo.addColumn("Fecha Comentario");
        jtabledatos.setModel(modelo);
        String consultasql="select*from comentarios";
